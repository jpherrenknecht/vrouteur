...
var controller = function () {
    ...
    var lbBoatname,lbBoatname2,lbTeamname;
...
//              var sailDef = getSailDef(boatPolars.sail, data.sail % 10);
    ...
    function updatePosition(message, r) {
        ...
        lonjp.innerHTML  =r.curr.pos.lon;
        latjp.innerHTML  =r.curr.pos.lat;
        lastcalcdatejp.innerHTML=formatDate(r.curr.lastCalcDate);
    ...
    function callRouterJP(raceId, userId, beta) {
        var optionBits = {
            "winch": 4,
            "foil": 16,
            "light": 32,
        ...
        if (!race.url) {
            ...
            var url = baseURL + "/windleaf?latdep=" + pos.lat + "&lngdep=" + pos.lon +"&race="+raceId+
            "&o=" + options + "&twa=" + twa + "&userid=" + uid + "&type=" + type;
            window.open(url, cbReuseTab.checked ? urlBeta : "_blank");
    ...
    var initialize = function () {
		...
		lbBoatname2 = document.getElementById("lb_boatname2");
    ...
    var callRouter = function (raceId, userId) {
        ...
        if (!races.get(raceId)) {
            ...
            callRouterJP(raceId, userId, beta);
        }
    }
        ...
        if (message == "Network.webSocketFrameSent") {
            ...
            if (response == undefined) {
                ...
                if (responseClass == ".AccountDetailsResponse") {
					...
					lbBoatname2.innerHTML = response.displayName;
                    ...
                    if (request == undefined) {
						...
						lbBoatname2.innerHTML = response.scriptData.me.displayName;
